...
// Cambia a false cuando la web esté lista
...
function actualizarWord() {

    const paginas =
        parseInt(document.getElementById("wordPaginas").value) || 0;

    totalWord = paginas * 5;

    document.getElementById("wordTotalHNL").innerText =
        totalWord.toFixed(2);

    document.getElementById("wordConvertido").innerText =
        convertir(totalWord);
}
